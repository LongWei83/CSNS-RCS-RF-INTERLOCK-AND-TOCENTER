...
epicsShareExtern rset *pvar_rset_biasdataRSET;
epicsShareExtern int (*pvar_func_biasdataRecordSizeOffset)(dbRecordType *pdbRecordType);
...
static const recordTypeLocation rtl[30] = {
    ...
    {pvar_rset_biasdataRSET, pvar_func_biasdataRecordSizeOffset}
};
...
epicsShareExtern dset *pvar_dset_devAiYewPlc;
...
epicsShareExtern dset *pvar_dset_devAoYewPlc;
epicsShareExtern dset *pvar_dset_devBiSoft;
epicsShareExtern dset *pvar_dset_devBiSoftRaw;
epicsShareExtern dset *pvar_dset_devBiYewPlc;
...
epicsShareExtern dset *pvar_dset_devBoYewPlc;
...
epicsShareExtern dset *pvar_dset_devMbbiDirectYewPlc;
...
epicsShareExtern dset *pvar_dset_devMbboDirectYewPlc;
...
epicsShareExtern dset *pvar_dset_devWfYewPlc;
...
static const dset * const devsl[50] = {
    ...
    pvar_dset_devSASoft,
    pvar_dset_devWfSoft,
    pvar_dset_devWfYewPlc,
    pvar_dset_devXxxSoft
};

epicsShareExtern drvet *pvar_drvet_drvNetMpf;
...
{
    const char *bldTop = "/home/long/Epics/apps/plcApp_IntLock";
